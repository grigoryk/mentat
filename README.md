# Project Mentat, grisha's fork
[![Build Status](https://travis-ci.org/mozilla/mentat.svg?branch=master)](https://travis-ci.org/mozilla/mentat)

*This fork is Grisha's personal explorations of this space. While Mozilla is [no longer actively developing Mentat](https://mail.mozilla.org/pipermail/firefox-dev/2018-September/006780.html), I'm still interested in the problem space and would like to push it forward - largely at my own pace.*
